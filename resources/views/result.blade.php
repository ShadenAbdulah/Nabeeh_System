...
@section('content')
    ...
    <div
        class="w-3/5 mx-auto grid grid-rows-3 gap-16 shadow-2xl shadow-[#6D6AB1]/10 p-10 rounded-3xl content-center text-center">
    ...
    <div class="mx-auto my-8 w-3/5">
        <div class="flex gap-7 justify-center">
            ...
            <h1 class="font-normal text-base mt-1.5 w-5/6 tracking-wide text-justify"><span
                    class="text-[#6D6AB1] font-medium">نَبِيـــه</span>
                هو أداة مساعدة
                للتشخيص
                ولا
                يمكن
