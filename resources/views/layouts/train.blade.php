<x-head session_name="{{$sample->id.'/train'}}">
    ...
    <div class="w-1/3 mx-auto my-32 bg-[#D9D9D9]/30 px-7 py-3 grid justify-items-center gap-y-5 rounded-2xl"
        ...
        <p class="font-medium text-justify">مهمة البداية ليست ضمن الاختبار، وهي لتدريب العينة على آلية الاختبار
            ولمساعدته
            ليتعرف على
            البيئة قبل البدء. ستظهر صفحة تحتوي على رسومات والمطلوب من العينة هو اعادة رسم ما هو موجود خلال ٥ دقائق كحد
            أقصى.</p>
    </div>
