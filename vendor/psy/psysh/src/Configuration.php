...
class Configuration
{
    ...
    {
        @trigger_error('`setTabCompletion` is deprecated; call `setUseTabCompletion` instead.', E_USER_DEPRECATED);
    ...
    {
        @trigger_error('`getTabCompletion` is deprecated; call `useTabCompletion` instead.', E_USER_DEPRECATED);
