 ...
 * @method static Cloud createS3Driver(array $config)
 ...
 * @method static FilesystemManager setApplication(Application $app)
 * @method static bool exists(string $path)
 * @method static string|null get(string $path)
 * @method static resource|null readStream(string $path)
 * @method static bool put(string $path, StreamInterface|\Illuminate\Http\File|UploadedFile|string|resource $contents, mixed $options = [])
 ...
 * @method static FilesystemAdapter assertExists(string|array $path, string|null $content = null)
 * @method static FilesystemAdapter assertMissing(string|array $path)
 * @method static FilesystemAdapter assertDirectoryEmpty(string $path)
 ...
 * @method static StreamedResponse response(string $path, string|null $name = null, array $headers = [], string|null $disposition = 'inline')
 * @method static StreamedResponse download(string $path, string|null $name = null, array $headers = [])
 * @method static string|false putFile(\Illuminate\Http\File|UploadedFile|string $path, \Illuminate\Http\File|UploadedFile|string|array|null $file = null, mixed $options = [])
 * @method static string|false putFileAs(\Illuminate\Http\File|UploadedFile|string $path, \Illuminate\Http\File|UploadedFile|string|array|null $file, string|array|null $name = null, mixed $options = [])
 ...
 * @method static FilesystemAdapter|mixed unless(Closure|mixed|null $value = null, callable|null $callback = null, callable|null $default = null)
