 ...
 * @method static PendingSingletonResourceRegistration singleton(string $name, string $controller, array $options = [])
 * @method static void apiSingletons(array $singletons, array $options = [])
 * @method static PendingSingletonResourceRegistration apiSingleton(string $name, string $controller, array $options = [])
 * @method static Router group(array $attributes, Closure|array|string $routes)
 ...
 * @method static Router substituteImplicitBindingsUsing(callable $callback)
 ...
 * @method static Router middlewareGroup(string $name, array $middleware)
 * @method static Router prependMiddlewareToGroup(string $group, string $middleware)
 * @method static Router pushMiddlewareToGroup(string $group, string $middleware)
 * @method static Router removeMiddlewareFromGroup(string $group, string $middleware)
 * @method static Router flushMiddlewareGroups()
 ...
 * @method static void setRoutes(RouteCollection $routes)
 * @method static void setCompiledRoutes(array $routes)
 * @method static array uniqueMiddleware(array $middleware)
 * @method static Router setContainer(Container $container)
