 ...
 * @method static QueueManager setApplication(Application $app)
 ...
 * @method static Job|null pop(string|null $queue = null)
 ...
 * @method static QueueFake except(array|string $jobsToBeQueued)
 ...
 * @method static Collection pushed(string $job, callable|null $callback = null)
 * @method static bool hasPushed(string $job)
 * @method static bool shouldFakeJob(object $job)
 * @method static array pushedJobs()
 * @method static QueueFake serializeAndRestore(bool $serializeAndRestore = true)
 *
